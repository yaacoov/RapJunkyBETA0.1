package com.codeoasis.testwaves.utils.BeatPlayerView;
...
/**
 * Created by Yarik on 8/13/2016.
 */
public class BeatPlayerView extends View implements OnPlayPauseToggleListener {
     ...
     * Constructor
     */
    public BeatPlayerView(Context context) {
        super(context);
        init(context, null);
    }
     ...
     * Constructor
     */
    public BeatPlayerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * Constructor
     */
    public BeatPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public BeatPlayerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
